...
class SearchView
{
    ...
    function GetPageListDM($list_len)
    {
        ...
        {
            return "<li class='pageinfo'><span><strong>1</strong> 页 / <strong>".$this->TotalResult."</strong> 条</span></li>";
        }
        if($this->TotalResult == 0)
        {
            return "<li class='pageinfo'><span><strong>0</strong> 页 / <strong>".$this->TotalResult."</strong> 条</span></li>";
        }
        $purl = $this->GetCurUrl();
        ...
        $infos = "<li class='pageinfo'><span>共 <strong>".$this->TotalResult."</strong> 条 / 共 <strong>{$totalpage}</strong> 页</span></li>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li class='prep'><a href='".$purl."PageNo=$prepagenum'>上一页</a></li>\r\n";
            $indexpage="<li class='firstp'><a href='".$purl."PageNo=1'>首页</a></li>\r\n";
        }
        else
        {
            $prepage.="<li class='pn prep'><a>上一页</a></li>\r\n";
            $indexpage="<li class='firstp no'><a>首页</a></li>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li class='nextp'><a href='".$purl."PageNo=$nextpagenum'>下一页</a></li>\r\n";
            $endpage="<li class='lastp'><a href='".$purl."PageNo=$totalpage'>末页</a></li>\r\n";
        }
        else
        {
            $nextpage.="<li class='pn nextp'><a>下一页</a></li>\r\n";
            $endpage="<li class='lastp no'><a>末页</a></li>\r\n";
        }
